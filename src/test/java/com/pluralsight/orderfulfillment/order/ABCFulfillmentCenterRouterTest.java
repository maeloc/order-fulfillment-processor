...
public class ABCFulfillmentCenterRouterTest {
	...
	public static class TestConfig extends SingleRouteCamelConfiguration {
		...
		@Bean org.apache.activemq.camel.component.ActiveMQComponent activeMq() {
		...
		public RouteBuilder route() {
			return new RouteBuilder() {
				...
				public void configure() throws Exception {
					...
					Namespaces namespace = new Namespaces("o", 
					...
					from("activemq:queue:ABC_FULFILLMENT_REQUEST")
						...
						.marshal()
						.csv()
						.to("file://C:/dev/tmp/abcfulfillmentcenter/out?fileName=abcfc-"
								+ dateString + ".csv")
						.setHeader("CamelFileName", constant("abcfc-" + dateString + ".csv"))
						.to("sftp://demo.wftpserver.com:2222?username=demo-user&password=demo-user")
	...
	public void test_success() throws InterruptedException {
		...
		testProducer.sendBody(fulfillmentCenterMessage4); // throw an exception
		
		// 2 - Wait until aggregation is complete.
		Thread.sleep(20000);
		
		// 3 - Print out the results to verify the aggregated message.
		//System.err.println(resultEndpoint.getExchanges().get(0).getIn().getBody());
