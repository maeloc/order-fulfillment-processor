...
@ContextConfiguration(
		classes = { FulfillmentCenterOneRouteTest.TestConfig.class },
		loader = org.apache.camel.test.spring.CamelSpringDelegatingTestContextLoader.class)
public class FulfillmentCenterOneRouteTest {
		...
		public RouteBuilder route() {
			return new RouteBuilder() {
				...
				public void configure() throws Exception {
					// 1 - Route from direct component to an ActiveMQ component
					...
					from("activemq:queue:FC1_FULFILLMENT_REQUEST")
						.to("log:com.pluralsight.orderfulfillment.order?showAll=true&multiline=true")
	...
	public void test_success() throws Exception {
		...
		FulfillmentResponse response = new Gson().fromJson(inMessage.getBody(String.class),
